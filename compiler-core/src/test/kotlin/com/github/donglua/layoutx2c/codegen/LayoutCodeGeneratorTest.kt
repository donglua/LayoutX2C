...
class LayoutCodeGeneratorTest {
    ...
    fun `supported attributes emit current view property code`() {
        ...
        assertThat(generated).contains("setTextColor(ResourceCompat.getColor(context, R.color.title))")
    ...
    fun `expanded text attributes emit text view property code`() {
        ...
        assertThat(generated).contains("setLineSpacing(java.lang.Math.round(4f * density).toFloat(), 1.2f)")
    ...
    fun `common view presentation attributes emit property code`() {
        ...
        assertThat(generated).contains("backgroundTintList = ResourceCompat.getColorStateList(context, R.color.title)")
        assertThat(generated).contains("foreground = ResourceCompat.getDrawable(context, R.drawable.title_background)")
        assertThat(generated).contains("foregroundTintList = ResourceCompat.getColorStateList(context, R.color.title)")
    ...
    fun `widget controls emit construction and property code`() {
        ...
        assertThat(generated).contains("progressTintList = ResourceCompat.getColorStateList(context, R.color.title)")
        assertThat(generated).contains("indeterminateTintList = ResourceCompat.getColorStateList(context, R.color.title)")
        assertThat(generated).contains("val root_child1 = SeekBar(context).apply {")
        assertThat(generated).contains("thumb = ResourceCompat.getDrawable(context, R.drawable.title_background)")
        ...
        assertThat(generated).contains("setIsIndicator(true)")
    ...
    fun `image view emits src scaleType and tint`() {
        ...
        assertThat(generated).contains("imageTintList = ResourceCompat.getColorStateList(context, R.color.demo_tint)")
    }
    ...
    fun `rich container and app bar controls emit construction and property code`() {
        ...
        assertThat(generated).contains("strokeColor = ResourceCompat.getColor(context, R.color.title)")
        ...
        assertThat(generated).contains("navigationIcon = ResourceCompat.getDrawable(context, R.drawable.title_background)")
